# Diff ZCF: `caso_00_base.cdr` vs `caso_21_foto_real.cdr`
...
### `content/data/Bitmaps.dat` — NOVO na variante (4320118 bytes)
```
           0  14 00 00 00 01 00 00 00 55 49 00 00 6e eb 41 00  ........UI..n.A.
          16  00 00 00 00 20 00 00 00 00 00 00 00 00 00 00 00  .... ...........
          32  02 00 00 00 ff 00 00 00 52 49 4e eb 41 00 00 00  ........RIN.A...
          48  00 00 4e 00 00 00 01 00 00 00 01 00 00 00 84 03  ..N.............
```
...
**Regiao 1: offset 374, 25 byte(s)**
```
base:
         358  6c 3a 69 6d 61 67 65 2d 68 65 69 67 68 74 3d 22  l:image-height="
         374  32 35 36 22 20 63 72 6c 3a 69 6d 61 67 65 2d 77  256" crl:image-w
         390  69 64 74 68 3d 22 33 38 33 22 20 66 75 6c 6c 2d  idth="383" full-
         406  70 61 74 68 3d 22 70 72 65                       path="pre
variante:
         358  6c 3a 69 6d 61 67 65 2d 68 65 69 67 68 74 3d 22  l:image-height="
         374  34 33 32 22 20 63 72 6c 3a 69 6d 61 67 65 2d 77  432" crl:image-w
         390  69 64 74 68 3d 22 32 35 36 22 20 66 75 6c 6c 2d  idth="256" full-
         406  70 61 74 68 3d 22 70 72 65                       path="pre
```
...
variante (inicio do miolo):
         337  20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20                  
         353  20 20 20 20 3c 72 64 66 3a 6c 69 3e 66 6f 74 6f      <rdf:li>foto
         369  5f 72 65 61 6c 2e 6a 70 65 67 3c 2f 72 64 66 3a  _real.jpeg</rdf:
...
variante (inicio do miolo):
          22  0a 3c 70 61 6c 65 74 74 65 20 67 75 69 64 3d 22  .<palette guid="
          38  34 37 65 36 38 31 65 36 2d 30 30 39 32 2d 34 63  47e681e6-0092-4c
          54  37 39 2d 61 64 34 61 2d 34 30 36 63 64 62 33 35  79-ad4a-406cdb35
          70  65 38 31 31 22 20 6e 61 6d 65 3d 22 50 61 6c 65  e811" name="Pale
          86  74 61 20 64 65 20 64 6f 63 75 6d 65 6e 74 6f 73  ta de documentos
         102  22 3e 3c 63 6f 6c 6f 72 73 3e 3c 70 61 67 65 3e  "><colors><page>
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante (inicio do miolo):
           0  ca e3 0e 25 44 cf 60 4e 93 c6 5f 71 47 19 94 06  ...%D.`N.._qG...
          16  10 81 f1 ff 02 00 00 00 02 00 00 00 f9 66 e2 ff  .............f..
          32  10 81 f1 ff 02 00 00 00 02 00 00 00 f9 66 e2 ff  .............f..
          48  10 81 f1 ff 02 00 00 00 02 00 00 00 f9 66 e2 ff  .............f..
          64  f8 df 80 7b af c7 7f 41 a3 ba f2 f0 cd 18 c9 c2  ...{...A........
...
variante (inicio do miolo):
          ...
          80  00 00 00 00 76 eb 41 00 00 00 00 00 00 00 00 00  ....v.A.........
  ... (regiao truncada; tamanho real 96 bytes)
```

### `previews/page1.png` — ALTERADO (829 -> 10631 bytes)

Tamanhos diferentes (delta +9802). Prefixo comum: 85 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [85..817) = 732 bytes, variante [85..10619) = 10534 bytes.
...
variante (inicio do miolo):
          69  73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64 00 00  s..........o.d..
          85  29 1c 49 44 41 54 78 5e ed 9c f7 57 1b 59 b6 a8  ).IDATx^...W.Y..
         101  ef 1f f2 7e 78 f3 d6 7b f7 be b7 d6 5b f7 ce ed  ...~x..{....[...
         117  b9 d3 3d 3d 3d dd 3d d3 d3 ce 6e 67 1b 83 31 6d  ..===.=...ng..1m
         133  b0 c9 60 72 ce 39 e7 28 72 4e 92 40 22 0b 10 20  ..`r.9.(rN.@".. 
         149  82 c8 12 51 12 d9 26 27 21 b2 88 55 6f 9d 2a 49  ...Q..&'!..Uo.*I
  ... (regiao truncada; tamanho real 96 bytes)
```

### `previews/thumbnail.png` — ALTERADO (935 -> 131605 bytes)

Tamanhos diferentes (delta +130670). Prefixo comum: 19 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [19..923) = 904 bytes, variante [19..131593) = 131574 bytes.
...
variante (inicio do miolo):
           3  47 0d 0a 1a 0a 00 00 00 0d 49 48 44 52 00 00 01  G........IHDR...
          19  00 00 00 01 b0 08 02 00 00 00 c9 da 2c 44 00 00  ............,D..
          35  00 01 73 52 47 42 00 ae ce 1c e9 00 00 00 04 67  ..sRGB.........g
          51  41 4d 41 00 00 b1 8f 0b fc 61 05 00 00 00 09 70  AMA......a.....p
          67  48 59 73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64  HYs..........o.d
          83  00 00 ff a5 49 44 41 54 78 5e dc bd 07 98 14 55  ....IDATx^.....U
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante:
       17327  20 20 20 20 20 20 20 22 67 75 69 64 22 3a 20 22         "guid": "
       17343  37 32 64 64 33 32 31 63 2d 37 39 32 61 2d 34 65  72dd321c-792a-4e
       17359  39 35 2d 38 33 30 66 2d 62 66 37 39 61 63 38 39  95-830f-bf79ac89
       17375  35 32 63 64 22 2c 0a 20 20 20 20 20 20 20 20 22  52cd",.        "
       17391  6e 61 6d 65                                      name
```
