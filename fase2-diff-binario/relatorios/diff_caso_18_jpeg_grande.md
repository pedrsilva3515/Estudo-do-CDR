# Diff ZCF: `caso_00_base.cdr` vs `caso_18_jpeg_grande.cdr`
...
### `content/data/Bitmaps.dat` — NOVO na variante (17280118 bytes)
```
           0  01 00 00 00 01 00 00 00 55 49 00 00 6e ac 07 01  ........UI..n...
          16  00 00 00 00 20 00 00 00 00 00 00 00 00 00 00 00  .... ...........
          32  02 00 00 00 ff 00 00 00 52 49 4e ac 07 01 00 00  ........RIN.....
          48  00 00 4e 00 00 00 01 00 00 00 01 00 00 00 60 09  ..N...........`.
```
...
variante (inicio do miolo):
         ...
         369  65 5f 67 72 61 6e 64 65 2e 6a 70 67 3c 2f 72 64  e_grande.jpg</rd
...
variante (inicio do miolo):
          22  0a 3c 70 61 6c 65 74 74 65 20 67 75 69 64 3d 22  .<palette guid="
          38  30 32 64 36 39 30 38 66 2d 33 35 38 34 2d 34 64  02d6908f-3584-4d
          54  62 37 2d 38 64 39 64 2d 37 62 64 39 31 30 38 31  b7-8d9d-7bd91081
          70  65 30 37 33 22 20 6e 61 6d 65 3d 22 50 61 6c 65  e073" name="Pale
          86  74 61 20 64 65 20 64 6f 63 75 6d 65 6e 74 6f 73  ta de documentos
         102  22 3e 3c 63 6f 6c 6f 72 73 3e 3c 70 61 67 65 3e  "><colors><page>
  ... (regiao truncada; tamanho real 96 bytes)
```
...
Tamanhos diferentes (delta +283). Prefixo comum: 22 bytes; sufixo comum: 209 bytes.
Miolo divergente: base [22..22148) = 22126 bytes, variante [22..22431) = 22409 bytes.
...
variante (inicio do miolo):
           0  ca e3 0e 25 44 cf 60 4e 93 c6 5f 71 47 19 94 06  ...%D.`N.._qG...
          16  10 81 f1 ff 02 00 00 00 90 82 10 00 23 11 d8 ff  ............#...
          32  10 81 f1 ff 02 00 00 00 90 82 10 00 23 11 d8 ff  ............#...
          48  10 81 f1 ff 02 00 00 00 90 82 10 00 23 11 d8 ff  ............#...
          64  f8 df 80 7b af c7 7f 41 a3 ba f2 f0 cd 18 c9 c2  ...{...A........
...
variante (inicio do miolo):
          ...
          80  00 00 00 00 76 ac 07 01 00 00 00 00 00 00 00 00  ....v...........
  ... (regiao truncada; tamanho real 96 bytes)
```

### `previews/page1.png` — ALTERADO (829 -> 3385 bytes)

Tamanhos diferentes (delta +2556). Prefixo comum: 85 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [85..817) = 732 bytes, variante [85..3373) = 3288 bytes.
...
variante (inicio do miolo):
          69  73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64 00 00  s..........o.d..
          85  0c ce 49 44 41 54 78 5e ed dc f9 53 d3 77 1e c7  ..IDATx^...S.w..
         101  f1 fe 11 6d 57 b4 d6 96 2a df 10 40 c1 03 15 b9  ...mW...*..@....
         117  af 70 df 81 40 20 24 10 92 70 04 c2 4d b8 03 c8  .p..@ $..p..M...
         133  19 0e 01 39 05 14 c4 5b eb 96 5a ab b5 b6 1e d8  ...9...[..Z.....
         149  ba 5a b5 6a ab b5 15 6f 40 74 db da da ed cc de  .Z.j...o@t......
  ... (regiao truncada; tamanho real 96 bytes)
```

### `previews/thumbnail.png` — ALTERADO (935 -> 10972 bytes)

Tamanhos diferentes (delta +10037). Prefixo comum: 19 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [19..923) = 904 bytes, variante [19..10960) = 10941 bytes.
...
variante (inicio do miolo):
          ...
          51  41 4d 41 00 00 b1 8f 0b fc 61 05 00 00 00 09 70  AMA......a.....p
          67  48 59 73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64  HYs..........o.d
          83  00 00 2a 71 49 44 41 54 78 5e ed dd 07 54 93 f7  ..*qIDATx^...T..
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante:
       17327  20 20 20 20 20 20 20 22 67 75 69 64 22 3a 20 22         "guid": "
       17343  35 39 33 38 65 37 64 65 2d 33 36 38 37 2d 34 35  5938e7de-3687-45
       17359  38 33 2d 39 31 31 66 2d 37 37 38 61 34 61 66 34  83-911f-778a4af4
       17375  36 31 37 63 22 2c 0a 20 20 20 20 20 20 20 20 22  617c",.        "
       17391  6e 61 6d                                         nam
```
