# Diff ZCF: `caso_00_base.cdr` vs `caso_08_bitmap_dpi_300.cdr`
...
variante:
         381  6c 3a 69 6d 61 67 65 2d 77 69 64 74 68 3d 22 33  l:image-width="3
         397  34 31 22 20 66 75 6c 6c 2d 70 61 74 68 3d 22 70  41" full-path="p
         413  72 65                                            re
```
...
variante (inicio do miolo):
         ...
         369  65 5f 64 70 69 33 30 30 2e 6a 70 67 3c 2f 72 64  e_dpi300.jpg</rd
...
variante (inicio do miolo):
          22  0a 3c 70 61 6c 65 74 74 65 20 67 75 69 64 3d 22  .<palette guid="
          38  63 38 38 33 32 38 34 34 2d 64 34 32 37 2d 34 64  c8832844-d427-4d
          54  64 61 2d 38 62 31 35 2d 31 66 63 36 38 30 65 31  da-8b15-1fc680e1
          70  37 66 37 66 22 20 6e 61 6d 65 3d 22 50 61 6c 65  7f7f" name="Pale
          86  74 61 20 64 65 20 64 6f 63 75 6d 65 6e 74 6f 73  ta de documentos
         102  22 3e 3c 63 6f 6c 6f 72 73 3e 3c 70 61 67 65 3e  "><colors><page>
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante (inicio do miolo):
           0  ca e3 0e 25 44 cf 60 4e 93 c6 5f 71 47 19 94 06  ...%D.`N.._qG...
          16  10 81 f1 ff 02 00 00 00 02 00 00 00 e3 ea ed ff  ................
          32  10 81 f1 ff 02 00 00 00 02 00 00 00 e3 ea ed ff  ................
          48  10 81 f1 ff 02 00 00 00 02 00 00 00 fb e6 ed ff  ................
          64  f8 df 80 7b af c7 7f 41 a3 ba f2 f0 cd 18 c9 c2  ...{...A........
...
### `previews/page1.png` — ALTERADO (829 -> 1400 bytes)

Tamanhos diferentes (delta +571). Prefixo comum: 85 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [85..817) = 732 bytes, variante [85..1388) = 1303 bytes.
...
variante (inicio do miolo):
          69  73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64 00 00  s..........o.d..
          85  05 0d 49 44 41 54 78 5e ed db bd 6b 94 07 00 c7  ..IDATx^...k....
         101  f1 5c a4 45 5c 1c c4 d1 a5 2f 83 a3 4f c8 5d 63  .\.E\..../..O.]c
         117  6a b0 42 c4 42 6c a5 0e 4a c5 0a 45 28 c5 aa 28  j.B.Bl..J..E(..(
         133  04 62 11 43 ae b5 60 eb d0 b7 7f 20 28 88 7d 11  .b.C..`.... (.}.
         149  fa 62 3b 38 34 b6 f6 02 ed e8 50 87 96 80 b8 99  .b;84.....P.....
  ... (regiao truncada; tamanho real 96 bytes)
```

### `previews/thumbnail.png` — ALTERADO (935 -> 8365 bytes)

Tamanhos diferentes (delta +7430). Prefixo comum: 19 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [19..923) = 904 bytes, variante [19..8353) = 8334 bytes.
...
variante (inicio do miolo):
           3  47 0d 0a 1a 0a 00 00 00 0d 49 48 44 52 00 00 01  G........IHDR...
          19  55 00 00 01 00 08 02 00 00 00 8c 2d 72 3d 00 00  U..........-r=..
          35  00 01 73 52 47 42 00 ae ce 1c e9 00 00 00 04 67  ..sRGB.........g
          51  41 4d 41 00 00 b1 8f 0b fc 61 05 00 00 00 09 70  AMA......a.....p
          67  48 59 73 00 00 0e c3 00 00 0e c3 01 c7 6f a8 64  HYs..........o.d
          83  00 00 20 42 49 44 41 54 78 5e ed 9d 7b 98 5c 65  .. BIDATx^..{.\e
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante:
       17327  20 20 20 20 20 20 20 22 67 75 69 64 22 3a 20 22         "guid": "
       17343  63 32 33 61 34 38 35 32 2d 63 31 61 63 2d 34 31  c23a4852-c1ac-41
       17359  38 30 2d 39 63 63 30 2d 63 32 61 63 38 66 63 33  80-9cc0-c2ac8fc3
       17375  33 35 36 37 22 2c 0a 20 20 20 20 20 20 20 20 22  3567",.        "
       17391  6e 61 6d 65                                      name
```
