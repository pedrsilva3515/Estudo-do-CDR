# Diff ZCF: `caso_00_base.cdr` vs `caso_04_add_bitmap_bmp.cdr`
...
variante (inicio do miolo):
         ...
         369  65 5f 62 61 73 65 2e 62 6d 70 3c 2f 72 64 66 3a  e_base.bmp</rdf:
...
variante (inicio do miolo):
          22  0a 3c 70 61 6c 65 74 74 65 20 67 75 69 64 3d 22  .<palette guid="
          38  30 66 63 32 31 36 33 35 2d 39 62 37 61 2d 34 63  0fc21635-9b7a-4c
          54  38 63 2d 62 30 61 37 2d 32 36 35 37 38 66 64 61  8c-b0a7-26578fda
          70  31 30 37 31 22 20 6e 61 6d 65 3d 22 50 61 6c 65  1071" name="Pale
          86  74 61 20 64 65 20 64 6f 63 75 6d 65 6e 74 6f 73  ta de documentos
         102  22 3e 3c 63 6f 6c 6f 72 73 3e 3c 70 61 67 65 3e  "><colors><page>
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante:
       17328  20 20 20 20 20 20 22 67 75 69 64 22 3a 20 22 33        "guid": "3
       17344  33 35 35 33 37 32 35 2d 61 38 61 63 2d 34 35 37  3553725-a8ac-457
       17360  66 2d 61 37 37 66 2d 38 65 62 35 35 38 35 61 35  f-a77f-8eb5585a5
       17376  63 35 31 22 2c 0a 20 20 20 20 20 20 20 20 22 6e  c51",.        "n
       17392  61 6d 65                                         ame
```
