# Diff ZCF: `caso_00_base.cdr` vs `caso_01_add_bitmap_jpeg.cdr`
...
Tamanhos diferentes (delta +283). Prefixo comum: 22 bytes; sufixo comum: 62 bytes.
Miolo divergente: base [22..22295) = 22273 bytes, variante [22..22578) = 22556 bytes.
...
### `previews/page1.png` — ALTERADO (829 -> 2034 bytes)

Tamanhos diferentes (delta +1205). Prefixo comum: 85 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [85..817) = 732 bytes, variante [85..2022) = 1937 bytes.
...
### `previews/thumbnail.png` — ALTERADO (935 -> 10051 bytes)

Tamanhos diferentes (delta +9116). Prefixo comum: 19 bytes; sufixo comum: 12 bytes.
Miolo divergente: base [19..923) = 904 bytes, variante [19..10039) = 10020 bytes.
