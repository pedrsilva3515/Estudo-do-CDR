# Diff ZCF: `caso_00_base.cdr` vs `caso_02_add_bitmap_png.cdr`
...
variante (inicio do miolo):
         ...
         369  65 5f 62 61 73 65 2e 70 6e 67 3c 2f 72 64 66 3a  e_base.png</rdf:
...
variante (inicio do miolo):
          22  0a 3c 70 61 6c 65 74 74 65 20 67 75 69 64 3d 22  .<palette guid="
          38  64 38 39 32 39 64 37 36 2d 62 61 35 32 2d 34 63  d8929d76-ba52-4c
          54  35 66 2d 61 35 39 33 2d 36 33 65 30 39 30 34 32  5f-a593-63e09042
          70  65 35 30 39 22 20 6e 61 6d 65 3d 22 50 61 6c 65  e509" name="Pale
          86  74 61 20 64 65 20 64 6f 63 75 6d 65 6e 74 6f 73  ta de documentos
         102  22 3e 3c 63 6f 6c 6f 72 73 3e 3c 70 61 67 65 3e  "><colors><page>
  ... (regiao truncada; tamanho real 96 bytes)
```
...
variante:
       17327  20 20 20 20 20 20 20 22 67 75 69 64 22 3a 20 22         "guid": "
       17343  64 65 39 32 33 39 30 62 2d 33 66 35 36 2d 34 39  de92390b-3f56-49
       17359  66 62 2d 38 38 35 66 2d 30 64 32 30 32 34 31 61  fb-885f-0d20241a
       17375  33 39 33 30 22 2c 0a 20 20 20 20 20 20 20 20 22  3930",.        "
       17391  6e 61 6d 65                                      name
```
